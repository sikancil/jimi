...
exports.static_serve = function(req, res, filename) {
    var body, headers;
...
exports.run = function(app, port) {
    sys.puts('[jimi] http://127.0.0.1:' + port + '/');
...
exports.make_app = function(url_mappings, options) {
    url_mappings = build_url_mappings(url_mappings);
    var compiled = url_mappings.map(function(pair) {
    ...
    app.urls = {};
    url_mappings.forEach(function (item) { app.urls[item[2]] = item[0]; });
    return app;
}
