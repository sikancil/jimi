...
object.mixin(FilterExpression.prototype, {
...
function Context(o) {
    ...
    this.filters = require('./defaults').filters;
}

object.mixin(Context.prototype, {
    get: function (name) {
...
object.mixin(Template.prototype, {
